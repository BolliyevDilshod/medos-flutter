...
import 'package:medos/Auth_Pharmacy/reg_pharmacy_two.dart';
class RegPharmacy extends StatefulWidget {
  const RegPharmacy({super.key});

  @override
  State<RegPharmacy> createState() => _RegPharmacyState();
}

class _RegPharmacyState extends State<RegPharmacy> {
          ...
          children: [
            Padding(
              ...
              child: Text(
                ...
                "Dorixona haqidagi ma'lumotlarni kiriting",
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                textAlign: TextAlign.center,
                "Dorixona akkountingizni ochish va ro'yxatdan o'tkazish uchun bu juda muhim ",
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) =>RegPharmacyTwo()));
                    },
                    style: ElevatedButton.styleFrom(
